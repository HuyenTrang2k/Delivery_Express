...
<div class="modal fade" id="newStockInRequest" tabindex="-1" role="dialog" aria-labelledby="newStockInRequestLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= $root . "Home/NewStockInRequest" ?>" method="post" onsubmit="return checkStock_in()">
                <div class="modal-body">
                    <div class="form-group">
                        <div class="input-group">
                            <input name="request_id" id="request_id" type="text" class="form-control rounded w-100" placeholder="Nhập đơn hàng" onkeypress="clearError()">
                        </div>
                    </div>
                    <div class="form-group">
                        <input name="note" type="text" class="form-control" id="note" placeholder="Nhập ghi chú" onkeypress="clearError()">
                    </div>
                    <div class="form-group">
                        <select class="form-control" name="stock" id="stock" class="w-100" onkeypress="clearError()">
                ...
                <div style="padding: 0 0 20px 10px" id="error_stock_in"><?= $error ?></div>
            </form>
        </div>
    </div>
</div>
