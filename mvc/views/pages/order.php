...
<div class="modal fade" id="createOrder" tabindex="-1" role="dialog" aria-labelledby="createOrderLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= $root . "Home/NewOrder" ?>" method="post" onsubmit="return checkOrder()">
                <div class="modal-body">
                    <div class="form-group">
                        <input name="fullname" id="fullname" type="text" class="form-control" placeholder="Nhập họ tên người nhận" onkeypress="clearError()">
                    </div>
                    <div class="form-group">
                        <input name="phone" type="text" class="form-control" id="phone2" placeholder="Nhập số điện thoại người nhận" onkeypress="clearError()">
                    </div>
                    <div class="form-group">
                        <input name="address" type="text" class="form-control" id="address" placeholder="Nhập địa chỉ người nhận" onkeypress="clearError()">
                    </div>
                    <div class="form-group row">
                        <div class="input-group mb-3 col-md-6">
                            ...
                            <input name="weight" id="weight" type="number" class="form-control" placeholder="" onkeypress="clearError()">
                        </div>
                        ...
                        <div class="input-group mb-3 col-md-6">
                            ...
                            <input name="collect" id="collect" type="number" class="form-control" placeholder="" onkeypress="clearError()">
                        </div>
                    </div>
                </div>
                ...
                <div style="padding: 0 0 20px 10px" id="error_order"><?= $error ?></div>
            </form>
        </div>
    </div>
</div>
